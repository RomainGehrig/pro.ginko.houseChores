...
Quick session, either from its details or by taking it out of the bundle; it
stays available if you decide to add it yourself. Going over the budget is a
plain readout, not an error.
